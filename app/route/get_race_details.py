...
from app.route.query import GET_RACE_DETAILS_BY_CIRCUIT_ID_AND_YEAR,GET_QUALIFICATION_DETAILS_BY_TYPE_BY_CIRCUIT_BY_YEAR,GET_FREE_PRACTICE_DETAILS_BY_SESSION_BY_CIRCUIT_BY_YEAR,GET_SPRINT_RACE_DETAILS_BY_CIRCUIT_BY_YEAR,GET_SPRINT_QUALIFICATION_DETAILS_BY_CIRCUIT_BY_YEAR
...
def get_sprint_race_details_by_circuit_by_year(circuit_id,year):
    return fetch_utils.fetch_details(GET_SPRINT_RACE_DETAILS_BY_CIRCUIT_BY_YEAR,(f"%{circuit_id}%",year))

def get_sprint_qualification_details_by_circuit_by_year(circuit_id,year):
    return fetch_utils.fetch_details(GET_SPRINT_QUALIFICATION_DETAILS_BY_CIRCUIT_BY_YEAR,(f"%{circuit_id}%",year))
