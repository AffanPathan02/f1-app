...
def get_qualification_details_by_circuit_by_year(race_type,circuit_id,year):
    return fetch_utils.fetch_details(GET_QUALIFICATION_DETAILS_BY_TYPE_BY_CIRCUIT_BY_YEAR,(race_type,f"%{circuit_id}%",year))

def get_free_practise_details_by_circuit_by_year(race_type,circuit_id,year):
    return fetch_utils.fetch_details(GET_FREE_PRACTICE_DETAILS_BY_SESSION_BY_CIRCUIT_BY_YEAR,(race_type,f"%{circuit_id}%",year))
